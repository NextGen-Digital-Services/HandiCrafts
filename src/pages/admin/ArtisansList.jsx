    ...
    <div className="admin-layout">
      ...
      <main className="admin-main">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1.25rem', marginBottom: '2rem' }}>
          ...
          <Link to="/admin/artisans/new" className="btn btn-brass" style={{ flex: '1 1 auto', maxWidth: 'max-content' }}>
        ...
        <div style={{ marginBottom: '2rem', maxWidth: '400px', width: '100%', position: 'relative' }}>
          <input
            type="text"
            placeholder="Search artisans by name, technique..."
            value={searchQuery}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1.5rem' }}>
          {filteredArtisans.map((artisan) => (
            ...
            >
              <div>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '1rem' }}>
                  <img
                    ...
                    alt={artisan.name}
                    style={{ width: '56px', height: '56px', borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--color-brass)', flexShrink: 0 }}
                  />
                  <div>
                    <h3 style={{ fontSize: '1.15rem', color: 'var(--color-bordeaux-deep)' }}>{artisan.name}</h3>
                ...
                <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: 'rgba(58, 42, 34, 0.8)', marginBottom: '1rem', borderLeft: '2px solid var(--color-brass)', paddingLeft: '0.6rem' }}>
                  "{artisan.quote}"
                </p>

                <div style={{ fontSize: '0.8rem', color: 'gray', marginBottom: '1.25rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '0.8rem', borderTop: '1px solid var(--color-ivory-deep)' }}>
                ...
                <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center' }}>
                  ...
                  <button onClick={() => handleDelete(artisan.id)} style={{ color: '#E57373', padding: '0.2rem' }} title="Delete Artisan">
                    <Trash2 size={18} />
                  </button>
                </div>
              </div>
